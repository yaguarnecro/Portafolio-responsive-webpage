...
var navItem = document.querySelectorAll('.nav-item'); //pero con los nav-item, al ser varios, se usa query.selector.all.
//que entrega un node list (algo asi como un array)
//set Initial State Of menu

var showMenu = false; //estado inicial del menu, cerrado abierto, false, true

menuBtn.addEventListener('click', toggleMenu); //EventListener, para cuando demos click
//se activa la función toggleMenu.

function toggleMenu() {
  if (!showMenu) {
    //si esta cerrado, false
    ...
    //aqui es lo contrario a lo anterior 
